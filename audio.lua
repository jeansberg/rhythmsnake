...
function audio.init()
    ...
    songPhases.active = love.audio.newSource("content/song_active.ogg", "static")
    songPhases.active:setLooping(true)
    songPhases.active:setVolume(0)

    songPhases.passive = love.audio.newSource("content/song_passive.ogg", "static")
    songPhases.passive:setLooping(true)
    songPhases.passive:setVolume(0)

    songPhases.gameover = love.audio.newSource("content/song_gameover.ogg", "static")
